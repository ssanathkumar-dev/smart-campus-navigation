...
- **Points of Interest (POIs):** Markers for all key buildings, labs, sports grounds, and classrooms.
- **Layered POI System:** Markers for individual rooms appear as the user zooms in on a building, preventing clutter on the map.
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/ssanathkumar-dev/smart-campus-navigation.git]
    (https://github.com/ssanathkumar-dev/smart-campus-navigation.git)
    ```
2.  **Navigate to the project folder:**
    ```bash
    cd smart-campus-navigation/frontend
    ```
3.  **Open the project:**
